...
// step — 940/39 across, 440/29 down, the same in every cut — but 42 x 60 of
// them rather than 40 x 30, so it is a slab with mass rather than a stripe. The
// band between its top edge and the mesh's lowest node is 245 world px: enough
// for the 250-tall cluster and the rack under it to drop into it without the
// resolve ever crowding the field, and no more.
// ---------------------------------------------------------------------------
