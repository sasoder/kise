...
// ---------------------------------------------------------------------------
// incidentHumansV2 — V2 COPY (v2t, 2026-09-23) of incidentHumans.tsx on the V2 world:
// identical except the import is `incidentSharedV2`. V1 incidentHumans.tsx stays frozen
...
// --- the entrance -----------------------------------------------------------
// V2 (v2t, 2026-09-23): the glide from the rack close-up to the humans is ~1800
// world px on the V2 layout, so inside the speed cap the humans only come into
// frame ~G478; they rise as they enter (landed G494, before "dark" 497).
export const HUMANS_IN = [476, 479, 482];
...
export const HUMANS_LANDED = Math.max(...HUMANS_IN) + HUMANS_IN_F; // V2: 494
