...
export type TrainedAgainstEachOtherGridProps = z.infer<typeof schema>;

export const defaultProps: TrainedAgainstEachOtherGridProps = schema.parse({
  accent: '#48D9FF',
...
const TrainedAgainstEachOtherGrid: React.FC<TrainedAgainstEachOtherGridProps> = ({
  accent,
  shadow,
  axisWidth,
  base,
...
export default TrainedAgainstEachOtherGrid;
