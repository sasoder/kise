...
const LEDGE_W = 116;
// The OpenAI mark (Simple Icons `public/si-openai.svg`, one compound path in a
// 24-unit box) under the floor rule: the house brand-mark size, white ink, the
// same per-icon shadow as the rules and the persons. Added at the user's
// request after v2 ("just add the openai logo under the bar chart").
const MARK_SIZE = 108;
        ...
        >
          ...
          >
            ...
            <g style={{ filter: icon }}>
              ...
              {/* the OpenAI mark, centred under the floor */}
              <g
